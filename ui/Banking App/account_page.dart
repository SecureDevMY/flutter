      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              _buildSpendingCategory(Colors.black87, 'Subscription', '\$8,221.00'),
              _buildSpendingCategory(primaryBlue, 'Friend & Family', '\$4,300.10'),
            ],
          )
        ],
      ),
              ...
              children: [
                ...
                RichText(
                  text: const TextSpan(
                    ...
                    children: [
                      TextSpan(text: 'Invite your friends to managing\ntheir finances and get '),
                      TextSpan(
                        text: '\$100',
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
