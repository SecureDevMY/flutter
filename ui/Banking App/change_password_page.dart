...
class _ChangePasswordPageState extends State<ChangePasswordPage> with SingleTickerProviderStateMixin {
        ...
        content: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.check_circle_outline, color: successGreen, size: 60),
            ),
  ...
  Future<void> _changePassword() async {
    ...
    if(_currentPasswordController.text == _newPasswordController.text) {
      _showErrorDialog('New password must be diffenet from current password.');
      return;
    }
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [primaryBlue.withOpacity(0.2),secondaryBlue.withOpacity(0.2)],
